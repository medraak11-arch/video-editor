/* ---------------------------------------------------------------------------
   ...
   The inventory is ELEVEN: Button, IconButton, NumericField, TimecodeField,
   TextField, Select, InlineNotice, Panel, Tooltip, Dialog, Menu (with MenuItem).
   ...
   export dialog needs both. The alternative was a bespoke <input> and a
   hand-rolled listbox inside the export slice, which §5 forbids outright. Each
   new file states the reasoning in its own header. The extension is deliberate
   and recorded; it is not a licence to add a twelfth.
